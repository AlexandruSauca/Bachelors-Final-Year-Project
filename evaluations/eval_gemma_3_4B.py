...
from load_gemma_4b import model, processor
...
file_json = "./results/gemma_3_4B.jsonl"
...
def main():
    ...
    results = evaluate_mmlb(files, output_gemini, data_root, model, processor, prompt_eval)
    ...
    if all_scores:
        ...
        print("\n---")
        print(f"Final Overall Average Score: {final_average:.2f} / 5.0")   # 2.0 / 5.0  really depends on how much the api enters timeout
    else:
    ...
    if all_rouge:
        ...
        print("\n---")
        print(f" > Final Average RougeLSum Score: {final_rouge_100:.2f}") # 16.64 similar to publication
    else:
    ...
    if all_p_bert:
        ...
        print("\n---")
        print(f" > Final Average Precion for  BertScore: {final_p_100:.2f}")  # 59.25
    else:
    ...
    if all_r_bert:
        ...
        print("\n---")
        print(f" > Final Average Recall for  BertScore: {final_R_100:.2f}")  # 55.52
    else:
    ...
    if all_f1_bert:
        ...
        print("\n---")
        print(f" > Final Average F1 score for  BertScore: {final_f1_100:.2f}")  # 57.18
    else:
