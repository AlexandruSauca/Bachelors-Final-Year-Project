...
from load_qwen_2_5_3B import model , processor
...
file_json = "./results/qwen_2_5_3B_results.jsonl"
...
output_qwen2 = "./results/qwen_2_5_3B_results.jsonl"
...
def main():
    ...
    plt.tight_layout() 
    plt.savefig("Qwen2.5_VL_3B_results.png")
    plt.show()
