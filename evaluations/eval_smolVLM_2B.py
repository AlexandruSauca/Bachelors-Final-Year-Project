...
from load_smolVLM import model , processor
...
output_qwen2 = "./results/smolVLM_2B_results.jsonl"
...
def main():
    ...
    if all_scores:
        ...
        print("\n---")
        print(f"Final Overall Average Score: {final_average:.2f} / 5.0")   # 1.76 / 5.0  really depends on how much the api enters timeout
    else:
    ...
    if all_p_bert:
        ...
        print("\n---")
        print(f" > Final Average Precion for  BertScore: {final_p_100:.2f}")  # 58.02
    else:
    ...
    if all_r_bert:
        ...
        print("\n---")
        print(f" > Final Average Recall for  BertScore: {final_R_100:.2f}")  # 54.05
    else:
    ...
    if all_f1_bert:
        ...
        print("\n---")
        print(f" > Final Average F1 score for  BertScore: {final_f1_100:.2f}")  # 55.78
    else:
    ...
    plt.title(f"Evaluation Results for SmolVLM (Scores 0-100)")
    plt.ylabel("Score")
    ...
    plt.tight_layout() 
    plt.savefig("SmolVLM_results.png")
    plt.show()
