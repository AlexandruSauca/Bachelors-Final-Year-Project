...
def hybrid_search(query, top_k_search=15):
...
def hybrid_search_with_HyDE(query, top_k_search=15):
    conn = get_db_connection()
...
def main():
    results = hybrid_search_with_HyDE(query)  #toggle between hybrid_search and hybrid_search_with_HyDE to see the difference
